...
#define MAX_APPLICATION_SPEED_RPM           4938 /*!< rpm, mechanical */
#define MIN_APPLICATION_SPEED_RPM           0 /*!< rpm, mechanical, absolute value */
#define M1_SS_MEAS_ERRORS_BEFORE_FAULTS     6 /*!< Number of speed measurement errors before main sensor goes in fault */

/****** State Observer + PLL ****/
#define VARIANCE_THRESHOLD                  0.01 /*!< Maximum accepted variance on speed estimates (percentage) */
...
#define STO_FIFO_DEPTH_DPP                  54 /*!< Depth of the FIFO used  to average mechanical speed in dpp format */
#define STO_FIFO_DEPTH_DPP_LOG              LOG2((54))
#define STO_FIFO_DEPTH_UNIT                 16 /*!< Depth of the FIFO used to average mechanical speed in the unit defined by #SPEED_UNIT */
...
#define PID_TORQUE_KP_DEFAULT               2959
#define PID_TORQUE_KI_DEFAULT               1973
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2959
#define PID_FLUX_KI_DEFAULT                 1973
...
#define PID_SPEED_KP_DEFAULT                2709/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define SPEED_BAND_LOWER_LIMIT              5 /*!< It expresses how much estimated speed can be below forced stator electrical
                                                 without being considered wrong. In 1/16 of forced speed */
