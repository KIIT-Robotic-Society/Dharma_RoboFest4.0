...
uint16_t readDistanceFromSensor1(void);
uint16_t readDistanceFromSensor2(void);
...
/* USER CODE END PFP */
statInfo_t_VL53L0X extraStats1, extraStats2;
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
...
int main(void)
{
  ...
  if(initVL53L0X(1, &hi2c1)){
	  HAL_UART_Transmit(&huart2, "sensor 1 initialized", strlen("hi"), HAL_MAX_DELAY);
  }

  setAddress_VL53L0X(0x62);
  extraStats1.address=0x62;

  HAL_GPIO_WritePin(V2_GPIO_Port, V2_Pin, GPIO_PIN_SET);
  HAL_Delay(50);

  if(initVL53L0X(1, &hi2c1)){
  HAL_UART_Transmit(&huart2, "sensor 2 initialized", strlen("hii"), HAL_MAX_DELAY);
  }

 setAddress_VL53L0X(0x64);
  extraStats2.address=0x64;
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  sprintf(msgBuffer_1, "Sensor 1 Distance: %d mm\r\n", distance1);
	  HAL_UART_Transmit(&huart2, (uint8_t*) msgBuffer_1, strlen(msgBuffer_1), HAL_MAX_DELAY);
	  sprintf(msgBuffer_2, "Sensor 2 Distance: %d mm\r\n", distance2);
	  HAL_UART_Transmit(&huart2, (uint8_t*) msgBuffer_2, strlen(msgBuffer_2), HAL_MAX_DELAY);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|V1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin V1_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|V1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : V2_Pin */
  ...
  /*Configure GPIO pin : V3_Pin */
  GPIO_InitStruct.Pin = V3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(V3_GPIO_Port, &GPIO_InitStruct);
