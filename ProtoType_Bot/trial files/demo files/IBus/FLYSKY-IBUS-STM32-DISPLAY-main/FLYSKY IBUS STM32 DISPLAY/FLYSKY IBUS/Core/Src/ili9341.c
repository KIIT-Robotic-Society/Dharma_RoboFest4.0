...
static void ILI9341_SPI_TxBuffer(uint8_t *buffer, uint16_t len)
{
	...
	HAL_SPI_Transmit_DMA(&ILI9341_SPI_PORT, buffer, len);
	//HAL_SPI_Transmit(HSPI_INSTANCE, buffer, len, 10);
}

void ILI9341_WriteBuffer(uint8_t *buffer, uint16_t len)
{
	HAL_GPIO_WritePin(ILI9341_DC_GPIO_Port, ILI9341_DC_Pin, GPIO_PIN_SET);	//data
	HAL_GPIO_WritePin(ILI9341_CS_GPIO_Port, ILI9341_CS_Pin, GPIO_PIN_RESET);//select
...
//	}
	...
	uint32_t counter = 0;
	for(uint32_t i = 0; i < ILI9341_WIDTH*ILI9341_HEIGHT*2/500; i++)
	{
